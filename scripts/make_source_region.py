...
#Todo: explain what the output will look like: area of 0's and 1's .
...
output_dir = 'C:/Users/Vincent/Spyder/TUDelft/'

#Other general settings are set per function (see below)
...
def mask_with_regionmask(region_source,region_names,preprocessfile,plotting):
    ...
    if plotting == True:
        ...
        plt.savefig(output_dir+'mask_with_regionmask_selected_region(s).png',dpi=200,bbox_inches='tight')
...
def mask_with_shapefile(shapefile,region_names,preprocessfile,plotting):
    ...
    if plotting == True:
        ...
        plt.savefig(output_dir+'mask_with_shapefile_selected_region(s).png',dpi=200,bbox_inches='tight')
...
def mask_around_point(centerpoint, radius, preprocessfile, plotting):
    ...
    if plotting == True:
        ...
        plt.savefig(output_dir+'mask_around_point_selected_region(s).png',dpi=200,bbox_inches='tight')
...
'''
Below, an example to run this code is given, adjust these to your data/contents
'''

# path = 'C:/Users/Spyder/SourceRegionDesigner/'
# mask_with_regionmask('giorgi',[1],path+'2022-08-31_fluxes_storages.nc',plotting=True)
# mask_with_shapefile(path+'hybas_af_lev01_v1c.shp',False,path+'2022-08-31_fluxes_storages.nc',plotting=True)
# mask_around_point((0,20), 20, path+'2022-08-31_fluxes_storages.nc',plotting=True)
