...
- A bug in the calculation of the vertical flux, where the divergence term was added instead of subtracted [#406](https://github.com/WAM2layers/WAM2layers/pull/406).
